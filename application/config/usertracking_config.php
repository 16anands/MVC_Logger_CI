...
| default: null
*/
$config['usertracking']['user_identifier'] = array("model", "login_m", "authorizationlog");
...
| default: [] = null
*/
$config['usertracking']['tracking_filter'][] = array("model", "login_m", "authorizationfilter", TRUE);

...
<script type="text/javascript">
    function saveMissing(flag){
        ...
        switch(flag){
            case 0:
                ...
                if(r == true){
                    window.location.href = "<?php echo BASE_URL;?>C_massociate/"+status;
                }
                break;
            case 1:
    ...
    $(document).ready(function(){   
        $('#action').change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo BASE_URL;?>C_massociate/getMetrics",
                data:'metricId='+val,
        ...
        $('#status').change(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo BASE_URL;?>C_massociate/getActions",
                data:'statusId='+val,
                success: function(data){
                    var response = JSON.parse(data);
...
<form method="POST" role="form" name="myForm" onsubmit="return saveMissing(1);" action="<?php echo BASE_URL;?>C_massociate/saveMissing/<?php echo $status[0]?>">
 <div id="wrapper">
 <!-- Page Content -->
    <div id="page-wrapper">

...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-7">
                <h2 class="page-header">Production Report (PLACEHOLDER)</h2>
            </div>
            <div class="col-lg-5">
                <h4 class="page-header" align="right">
                    <form  method="post" action="<?php echo BASE_URL;?>C_mteamlead/Production_Report">
                        <div class='col-md-4'>

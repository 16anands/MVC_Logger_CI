        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h2 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_mteamlead/Missing_EOB_Assigned" class="btn btn-danger" role="button"><i class="fa fa-check"></i> ASSIGNED</a>
                    ...
                    <a href="<?php echo BASE_URL;?>C_mteamlead/Missing_EOB_Pending" class="btn btn-success" role="button"><i class="fa fa-exclamation"></i> PENDING</a>
                                    ...
                                    for($i=0;$i<sizeof($missingeobresolveddata);$i++){
                                        echo "<tr>";
                                            ...
                                            <a class="btn btn-info btn-xs" 
                                                data-toggle="modal" 
                                                data-target='#myModal' 
                                                onclick="getmissingid('<?php echo $missingeobresolveddata[$i]['missingid'];?>')">

...
<?php /*//Page Variable*/ $WID = $work[0]["missingid"]; ?>
<script type="text/javascript">
function saveMissing(flag){   
    switch(flag){
        case 0:
            var r = confirm("Exiting Missing ?");
            if(r == true){
                window.location.href = "<?php echo BASE_URL;?>C_associate/Missing_EOB_Ready";
            }
            break;
         case 1:
...
<div id="wrapper">
    <div id="page-wrapper">
        <form method="POST" role="form" name="myForm" onsubmit="return saveMissing(2);" action="<?php echo BASE_URL;?>C_associate/Complete_Missing/<?php echo $WID;?>">
            <div class="row"><!-- ROW -->
                <div class="col-lg-6">
                    <h2 class="page-header">EOB Research Work Queue : <?php echo $WID; ?> </h2>
                </div>
                <div class="col-lg-6">
                        ...
                        <table class="table" id="WorkingFetch">
                            ...
                            <tbody>
                                <tr class="panel panel-info">
                                    ...
                                    <td class="panel-footer">
                                        <?php 
                                        $DepositeDate = $work[0]["DepositDate"];
                                        echo $work[0]["DepositDate"];
                                        ?>
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo "<p id='Amount'>".$work[0]["CheckAmt"]."</p>";?>  
                                        <?php 
                                        $Amount =  $work[0]["CheckAmt"];
                                        ?>
                                    </td>
                                    <td class="panel-footer">
                                        <?php 
                        ...
                        <div class="panel-group" id="accordion">
                            <div class="col-xs-12">
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseMissing" class="collapsed" aria-expanded="false">EOB Research Info</a>
                                        </h4>
                                    </div>
                                    <div id="collapseMissing" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                        <div class="panel-body">
                             ...
                             <tbody>
                                <tr class="panel panel-info">
                                    <td class="panel-footer">
                                        <?php echo $work[0]["Encounter"];?>
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["Amount"];?>        
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["CheckDate"];?>       
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["CheckNo"];?>
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["Website"];?>  
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["Availibility"]; ?>
                                    </td>
                                    <td class="panel-footer">
                                         <?php echo $work[0]["CPDIPage"]; ?>       
                                    </td>
                                    <td class="panel-footer">
                                         <?php echo $work[0]["RequestedDate"]; ?> 
                                    </td>
                                    <td class="panel-footer">
                                        <?php echo $work[0]["action"]; ?>   
                                    </td>
                                    <td class="panel-footer">
                                         <?php echo $work[0]["eta"]; ?>    
                                    </td>

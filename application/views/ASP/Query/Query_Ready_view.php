        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    ...
                    <a href="<?php echo BASE_URL;?>C_associate/Query_Posted" class="btn btn-info" role="button"><i class="fa fa-archive"></i> POSTED</a>
                </h4>
            </div>
        </div>
        <!-- /.col-lg-12 --> 
                                ...
                                <tbody>
                                    ...
                                    for($i=0;$i<sizeof($Query);$i++){
                                        ...
                                        if($Query[$i]["Status"]==33){
                                             $QueryID = BASE_URL.'C_associate/Query_Post/'.$Query[$i]["queryid"];

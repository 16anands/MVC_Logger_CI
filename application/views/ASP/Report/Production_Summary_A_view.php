...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-8">
                <h4 class="page-header" align="right">
                    <form  method="post" action="<?php echo BASE_URL;?>C_associate/Report_Section">
                        <div class="col-lg-2">
        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <h4 class="page-header" align="right">
                    <form  method="post" action="<?php echo BASE_URL;?>C_associate/Production_Summary">
                        <div class='col-md-4'>
                            <div class="form-group">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="PROD_S">
                                ...
                                <tbody>
                                <?php
                                for($i=0;$i<sizeof($production_summary);$i++){
                                    echo "<tr>";
                                  /*  echo "<td>".$production_summary[$i]['ESUM']."</td>";*/
                                    echo "<td>".$production_summary[$i]['Tsum']."</td>";
                                    echo "<td>".$production_summary[$i]['count_CPMAmt']." | $".$production_summary[$i]['sum_CPMAmt']."</td>";
                                    echo "<td>".$production_summary[$i]['othersome']."</td>";
                                    echo "<td>".$production_summary[$i]['count_Pending']." | $".$production_summary[$i]['sum_Pending']."</td>";
                                    $hours = floor($production_summary[$i]["WorkTime"]/3600);
                                    if ($hours < 10) {
                                        $hours = '0' . $hours;
                                    }
                                    $minutes = floor(($production_summary[$i]["WorkTime"]/ 60) % 60);
                                    if ($minutes < 10) {
                                        $minutes = '0' . $minutes;
                                    }
                                    $seconds = $production_summary[$i]["WorkTime"] % 60;
                                    if ($seconds < 10) {
                                        $seconds = '0' . $seconds;
                                    }
                                    echo "<td>".$hours.":".$minutes.":".$seconds."</td>" ;   
								    $LoginTime =  (strtotime($production_summary[$i]["Logout"]) - strtotime($production_summary[$i]["Login"]));    

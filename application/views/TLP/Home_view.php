        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-4">
                <h4 align="right" class="page-header">
                    <form  method="post" action="<?php echo BASE_URL;?>C_teamlead">
                        <div class='col-md-5'>
                            <div class="form-group">
                                <div class='input-group date' id='sdate'>    
                                    <input type='text' class="form-control" name='sdate'  id='sdate' value="<?php echo $sdate;?>" placeholder="End Date"/>
                    ...
                    <button type="submit" id="RECON" name="RECON" class="btn btn-primary" title="DOWNLOAD" onclick="Export('RECON_S','Reconciliation_LOG');">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="MTD_S">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2">Prior Month Rollover</th>

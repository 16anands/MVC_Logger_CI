        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h2 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_teamlead/Missing_EOB_Pending" class="btn btn-danger" role="button"><i class="fa fa-exclamation" title="Query Log"></i> PENDING</a>
                    <a href="<?php echo BASE_URL;?>C_teamlead/Missing_EOB_Issues" class="btn btn-warning" role="button"><i class="fa fa-question"></i> ISSUES</a>
                                ...
                                <tbody>
                                    ...
                                    for($i=0;$i<sizeof($missingeobassigneddata[0]);$i++){
                                        echo "<tr>";
                                            ...
                                            echo "<td>".$missingeobassigneddata[0][$i]["RequestedByAssociateName"];
                                            ?>

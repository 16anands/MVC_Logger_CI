...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-6">
                <h2 class="page-header">EOB Research - Resolved</h2>
            </div>
            <div class="col-lg-6">
...
<!--                    <a href="<?php echo BASE_URL;?>C_teamlead/Missing_EOB_Assigned" class="btn btn-danger" role="button"><i class="fa fa-check"></i> ASSIGNED</a>-->
                    ...
                    <a href="<?php echo BASE_URL;?>C_teamlead/Missing_EOB_Pending" class="btn btn-success" role="button"><i class="fa fa-exclamation"></i> PENDING</a>

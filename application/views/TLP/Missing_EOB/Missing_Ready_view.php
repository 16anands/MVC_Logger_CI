        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_teamlead/Missing_Pending" class="btn btn-danger" role="button"><i class="fa fa-question"></i> PENDING</a>
...
//                                        echo "<td>".$MEOB[$i]["AssignedIDAssociateName"]."</td>";
                                        if($MEOB[$i]["Status"]==33){
                                            $missingID = BASE_URL.'C_teamlead/Missing_Post/'.$MEOB[$i]["missingid"];

    ...
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            ...
            <div class="modal fade" id="myDepositModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="<?php echo BASE_URL;?>C_teamlead/Upload_Log"  method="post" enctype="multipart/form-data">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="col-lg-8">
                <h4 class="page-header" align="right">
                   ...
                   <a href="<?php echo BASE_URL;?>C_teamlead/Allot_Log/" class="btn btn-danger" role="button"><i class="fa fa-close"></i> NOT ASSIGNED</a>

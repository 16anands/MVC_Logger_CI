...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-6">
                <h2 class="page-header">Query Log Resolved</h2>
            </div>
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_teamlead/Query_Log/" class="btn btn-danger" role="button"><i class="fa fa-question" title="PENDING"></i> PENDING</a>
                      <a href="<?php echo BASE_URL;?>C_teamlead/Query_Log_Posted/" class="btn btn-info" role="button"><i class="fa fa-archive" title="RESOLVED" ></i> POSTED</a>

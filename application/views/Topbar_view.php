                ...
                <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                    <ul class="nav navbar-nav navbar-left navbar-top-links">
                        <li>
                            ...
                            switch ($Login_data[0]->AccessLevel) {
                                case 6:
                                    echo "href='".BASE_URL."C_manager";
                                    break;
                                case 14:
                                    echo "href='".BASE_URL."C_mteamlead";
                                    break;
                                case 13:
                                    echo "href='".BASE_URL."C_mdelegate";
                                    break;
                                case 12:
                                    echo "href='".BASE_URL."C_massociate";
                                    break;
                                case 4:
                                    echo "href='".BASE_URL."C_teamlead";
                                    break;
                                case 3:
                                    echo "href='".BASE_URL."C_delegate";
                                    break;
                                case 2:
                                    echo "href='".BASE_URL."C_associate";
                                    break;
                                default:
                                    echo "href='".BASE_URL."";
                            }
                            echo "'><img src='".BASE_URL."dist/img/logo.png' alt='Homepage' width='100' height='45'></a>";
                            ?>
                        </li>
                    </ul>

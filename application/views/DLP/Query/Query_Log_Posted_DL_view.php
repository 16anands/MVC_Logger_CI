...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-6">
                <h2 class="page-header">Queries Posted</h2>
            </div>
             <div class="col-lg-6">
                 <h4 class="page-header" align="right">
                     <a href="<?php echo BASE_URL;?>C_delegate/Query_Log_Archive" class="btn btn-success" role="button"><i class="fa fa-check"></i> RESOLVED</a>
                                    ...
                                    <?php
                                        for($i=0;$i<sizeof($querylogdata[0]);$i++){
                                            ...
                                            if($querylogdata[0][$i]['status']==18){
                                                ...
                                                echo "<td>".anchor(BASE_URL."/C_delegate/Query_Working/".$queryid,'Resolve')."</td>";
                                            }
                                            else{
                                                echo "<td>Posted</td>";
                                            }

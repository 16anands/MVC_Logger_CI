...
/*//Page Variable*/ $WID = $work[0]["queryid"]; ?>
...
function saveMissing(flag){   
    switch(flag){
        case 0:
            ...
            if(r == true){
                 window.location.replace("<?php echo BASE_URL;?>C_delegate/Query_Ready");
            }
            break;
         case 1:
...
<div id="wrapper">
    <div id="page-wrapper">
        <form method="POST" role="form" name="myForm" onsubmit="return saveMissing(2);" action="<?php echo BASE_URL;?>C_delegate/Complete_Query/<?php echo $WID;?>">
            <div class="row"><!-- ROW -->
                <div class="col-lg-6">

    ...
    {   
        switch(flag) 
        {
            case 0:
                    ...
                    if(r == true)
                    {
                         window.location.replace("<?php echo BASE_URL;?>C_delegate/Query_Log/");
                    }
                    break;
            case 1:
...
<form method="POST" role="form" name="myForm" onsubmit="return save(1);" action="<?php echo BASE_URL;?>C_delegate/Save_Query_Working">
<div id="wrapper">
<!-- Page Content -->
    <div id="page-wrapper">
                ...
                <div class="col-lg-14">
                    <table class="table">
                        <thead>
                            <tr>
                                <td>
                                    <h2 class="page-header">Query ID : <?php echo $queryidworkingdata[0]['queryid'];?></h2>
                                </td>

        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_delegate/Query_Pending" class="btn btn-danger" role="button"><i class="fa fa-question"></i> PENDING</a>
                                ...
                                <tbody>
                                    ...
                                    for($i=0;$i<sizeof($Query);$i++){
                                        ...
                                        if($Query[$i]["Status"]==33){
                                             $QueryID = BASE_URL.'C_delegate/Query_Post/'.$Query[$i]["queryid"];

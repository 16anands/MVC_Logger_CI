...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-6">
                <h2 class="page-header"> My EOB Research - Posted</h2>
            </div>
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_delegate/Missing_Ready" class="btn btn-warning" role="button"><i class="fa fa-star"></i> READY</a>

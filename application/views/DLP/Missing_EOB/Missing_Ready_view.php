        ...
        <div class="row"><!-- ROW -->
            ...
            <div class="col-lg-6">
                <h4 class="page-header" align="right">
                    <a href="<?php echo BASE_URL;?>C_delegate/Missing_Pending" class="btn btn-danger" role="button"><i class="fa fa-question"></i> PENDING</a>
                    <a href="<?php echo BASE_URL;?>C_delegate/Missing_Posted" class="btn btn-info" role="button"><i class="fa fa-archive"></i> POSTED</a>
                </h4>
            </div>
        </div>
        <!-- /.col-lg-12 --> 
                            ...
                            <table class="table table-striped table-bordered table-hover" id="MissingEOB">
                                ...
                                <tbody>
                                    ...
                                    for($i=0;$i<sizeof($MEOB);$i++){
                                        ...
                                        if($MEOB[$i]["Status"]==33){
                                            $missingID = BASE_URL.'C_delegate/Missing_Post/'.$MEOB[$i]["missingid"];

...
function saveMissing(flag){   
    switch(flag){
        case 0:
            ...
            if(r == true){
                 window.location.replace("<?php echo BASE_URL;?>C_delegate/Work_Queue/");
            }
            break;
        case 1:
            var r = confirm("Holding Batch ?");
            if(r == true){
                 window.location.replace("<?php echo BASE_URL;?>C_delegate/Hold_Queue/"+<?php echo $WID;?>)
            }
            break;
        case 2:
...
<div id="wrapper">
    <div id="page-wrapper">
        <form method="POST" role="form" name="myForm" autocomplete="off" onsubmit="return saveMissing(2);" action="<?php echo BASE_URL;?>C_delegate/Complete_Queue/<?php echo $WID;?>">
            <div class="row"><!-- ROW -->
                <div class="col-xs-12">
                <h2 class="page-header">Work ID # <?php echo $WID;?> 
                    <p align="right">

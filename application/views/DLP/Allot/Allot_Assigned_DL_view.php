...
<script type="text/javascript">
  ...
  //Work Status Update WRT Page Tabs
    function updateworkstatus(assignid){
        pageid = "Allot_Assigned_Log";
        workid = document.getElementById('workid').value;
         window.location.replace("<?php echo BASE_URL;?>C_delegate/updateworkstatus/"+workid+"/"+assignid+"/"+pageid);
    }
    //Allot Table Call
     $(document).ready( function () {
...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-4">
                <h2 class="page-header">Assigned Deposit Log</h2>
            </div>
            <!-- Modal -->
            ...
            <div class="col-lg-8">
                <h4 class="page-header" align="right">
                    ...
                    ||
                    <a href="<?php echo BASE_URL;?>C_delegate/Allot_Log" class="btn btn-info" role="button"><i class="fa fa-close"></i> NOT ASSIGNED</a>
                                ...
                                <tbody id="alothead">
                                    ...
                                    for($i=0;$i<sizeof($allotdata);$i++) {
                                        echo "<tr>";
                                            ...
                                            echo "<td>".$allotdata[$i]['teamlist'][0]['AssociateName'];
                                            ?>

...
<div id="wrapper">
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            <div class="col-lg-4">
                <h2 class="page-header">Processing Deposit Log</h2>
            </div>
             <!-- Modal -->
            ...
            <div class="col-lg-8">
                <h4 class="page-header" align="right">
                   ...
                   <a href="<?php echo BASE_URL;?>C_delegate/Allot_Log" class="btn btn-danger" role="button"><i class="fa fa-close"></i> NOT ASSIGNED</a>

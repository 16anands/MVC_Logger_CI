...
<script type="text/javascript">
    ...
    function updateworkstatus(workid,assignedID){
        pageid = "Allot_Log";
        window.location.replace("<?php echo BASE_URL;?>C_delegate/updateworkstatus/"+workid+"/"+assignedID+"/"+pageid);
      /*  window.location.href = "<?php echo BASE_URL;?>C_delegate/updateworkstatus/"+workid+"/"+assignedID+"/"+pageid;*/
    }
    $(document).ready( function () {          
        ...
        $('#button').click( function () {
            ...
            modalConfirm(function(confirm){
                if(confirm){
                    ...
                    window.location.replace("<?php echo BASE_URL;?>C_delegate/Delete_Log/"+workids+"/"+pageid);
                }
            });
        });
    });
    ...
    <div id="page-wrapper">
        <div class="row"><!-- ROW -->
            ...
            <div class="modal fade" id="myCPMModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="<?php echo BASE_URL;?>C_delegate/Upload_CPM/<?php echo($pageid);?>"  method="post" enctype="multipart/form-data">
                            <div class="modal-header">
            ...
            <div class="modal fade" id="myDepositModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="<?php echo BASE_URL;?>C_delegate/Upload_Log/<?php echo($pageid);?>"  method="post" enctype="multipart/form-data">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="col-lg-8">
                <h4 class="page-header" align="right">
                    ...
                    ||
                    <a href="<?php echo BASE_URL;?>C_delegate/Allot_Assigned_Log" class="btn btn-info" role="button"><i class="fa fa-check"></i> ASSIGNED</a>
                    <a href="<?php echo BASE_URL;?>C_delegate/Allot_Pending_Log" class="btn btn-danger" role="button"><i class="fa fa-exclamation"></i> PENDING</a>
                    <a href="<?php echo BASE_URL;?>C_delegate/Allot_Hold_Log" class="btn btn-warning" role="button"><i class="fa fa-stop"></i> HOLD</a>
                    <a href="<?php echo BASE_URL;?>C_delegate/Allot_Archive_Log" class="btn btn-success" role="button"><i class="fa fa-archive"></i> ARCHIVE</a>
                </h4>
            </div>
        </div>
        <div class="row">
